  ...
  return (
    <SafeAreaView
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={{paddingBottom: 20, paddingHorizontal: 24}}>
                ...
                <View style={styles.swapMenu}>
                  ...
                  <View style={styles.swapAmount}>
                    <TextInput
                      ...
                      value={swapAmount.to}
                      onChangeText={value =>
                        setSwapAmount({...swapAmount, to: value})
                      }
                    />
                    {swapAmount.to == '' && (
                      <CommonText
      ...
      <TouchableOpacity
        style={{marginBottom: 110, paddingHorizontal: 20}}
        onPress={() => navigation.navigate('SwapConfirmScreen')}>
        <CommonText
          style={[
            styles.reviewBtn,
            {
